...
public class MecanumDrive 
{
    ...
    public Output tankMecanumDrive(double leftValue, double rightValue, double strafeValue, double deadbandValue, int inverted)
    {
        ...
        double topLeftValue = (leftValue - strafeValue)*inverted;
        double bottomLeftValue = (leftValue + strafeValue)*inverted;
        double topRightValue = (rightValue + strafeValue)*inverted;
        double bottomRightValue = (rightValue - strafeValue)*inverted;
